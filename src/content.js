...
export const copy = {
  es: {
    metaTitle: 'Andrés Arbit | Director creativo y AI Artist',
    ...
    footer: { tagline: 'La marca no existe. El sistema sí.' },
    theater: {
      close: 'Cerrar',
      prev: 'Anterior',
      next: 'Siguiente',
  ...
  en: {
    metaTitle: 'Andrés Arbit | Creative Director and AI Artist',
    ...
    footer: { tagline: 'The brand doesn’t exist. The system does.' },
    theater: {
      close: 'Close',
      prev: 'Previous',
      next: 'Next',
...
export const projects = [
  {
    ...
    text: {
      es: 'Una marca de moda ficticia con códigos, casting, espacio, ritmo y archivo propios. El backstage de una presentación que nunca pasó. No es una campaña real, pero podría serlo.',
      en: 'A fictional fashion label with its own codes, casting, space, rhythm and archive. The backstage of a show that never happened. Not a real campaign, but it could be.',
    },
    roles: R,
  },
  {
  ...
  },
  {
    ...
    text: {
      es: 'No es moda. Es movimiento. Ritmo y fricción hasta que el cuerpo pide pausa. El descanso llega; las zapatillas quedan.',
      en: 'It’s not fashion. It’s movement. Rhythm and friction until the body asks for a pause. Rest arrives; the shoes stay.',
    },
    roles: R,
  },
  {
